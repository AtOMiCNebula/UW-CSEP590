...
// estimation-related
MJDLL double* mjGetSensor(void);
MJDLL void mjSetEstimator(const double* pos);

// setting data
MJDLL void mjSetMode(int mode);
MJDLL void mjSetState(int nq, int nv, int na, double time, 
					  const double* qpos, const double* qvel, const double* act);
MJDLL void mjSetControl(int nu, double* ctrl);
MJDLL void mjSetText(const char* text);
